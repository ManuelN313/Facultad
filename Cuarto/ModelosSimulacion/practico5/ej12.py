...
def Cauchy_trans(lamda):
    return lamda * np.tan(np.pi * (random() - 1/2))
...
print("\nEl Metodo de la Razon entre Uniformes tardo", time2 - time1, "seg en generar", Nsim, "simulaciones")
print("El Metodo de la Transformada Inversa tardo", time3 - time1, "seg en generar", Nsim, "simulaciones")