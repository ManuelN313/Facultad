...
data = np.loadtxt("./covid_italia.dat")
...
def graficar(hx, hy, a, b):
    x = np.linspace(1, 42, 250)
    plt.plot(x, a*((np.e)**(b*x)), label= "Aproximación")
