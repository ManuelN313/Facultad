...
#Datos Funcion 2B para [1.0, 2.0]
def fun_lab2ej2b(x):
    return x**2-3
    
hxb, hyb = rbisec(fun_lab2ej2b, [1.0, 2.0], 1e-5, 100) 
print("El metodo va a converger en " + str(len(hxb)) + " iteraciones para el intervalo [1.0, 2.0]")
print("Aproximaciones de la Raiz: ")
print (hxb)   

#Grafico Funcion 2B para [1.0, 2.0]
