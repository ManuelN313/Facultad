...
#Datos Funcion 2A para [0.8, 1.4]  
def fun_lab2ej2a(x):
    return 2*x-np.tan(x)
    
hxa, hya = rbisec(fun_lab2ej2a, [0.8, 1.4], 1e-5, 100)
print("El metodo va a converger en " + str(len(hxa)) + " iteraciones para el intervalo [0.8, 1.4]")
print("Aproximaciones de la Raiz: ")
print(hxa)

#Grafico Funcion 2A para [0.8, 1.4]
