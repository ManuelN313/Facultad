...
int main(int argc, char *argv[]) {
    ...
    /* reset counters and set time */
    array_copy(copy, array, length); //Makes a new copy of the original array
    reset_comparisons_counter();
    reset_swaps_counter();
    set_current_time();	
...
/* Conclusiones: El Selection Sort es el peor, el Quick Sort es bueno cuando tenemos un arreglo muy desordenado, pero malo cuando se   
   encuentra casi ordenado (especialmente si el pivot es el mayor o menor elemento del arreglo) y el insertion es t               
