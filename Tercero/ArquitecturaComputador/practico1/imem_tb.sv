module imem_tb();
	...
	logic [N-1: 0] qExpected [0:49] ='{32'hf8000001, 32'hf8008002, 32'hf8000203, 32'h8b050083, 32'hf8018003,
											     ...
											     32'hf81f83d9, 32'hb400001f, 32'h00000000, 32'h00000000, 32'h00000000};
		...
		begin
			for (int i = 0; i < 50; i++) 
				begin
					...
					#5ns;
					if (q !== qExpected[i])
						$display("Unexpected outcome in iteration %d", i);
					#5ns;
				end
			$stop;
		end
