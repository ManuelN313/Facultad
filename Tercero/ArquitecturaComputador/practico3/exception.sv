module exception (input logic clk, reset, Exc, ERet, inconBr,
				  input logic [3:0] EStatus,
				  input logic [63:0] NextPC_X, imem_addr_X, ALUBranch_X, readData1_X,
				  input logic [1:0] EDataSel,
				  output logic ExcAck, EProc_X,
				  output logic [63:0] PCBranch_X, readData_X,
				  output logic [63:0] EVAddr_X);

	logic [63:0] Exc_vector = 64'hD8, MuxOut;
	...
	mux2	  #(64) TYPE_BRANCH_SEL (ALUBranch_X, readData1_X, inconBr, MuxOut);
	mux2    #(64) RET_SEL (MuxOut, ERR_out, ERet, PCBranch_X);
